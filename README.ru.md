...
- **Предиктивный ввод (подсказки слов)**: над клавиатурой предлагаются слова для того, что набирается, — самые частые
  ...
  отключённым. Подсказки появляются с первой буквы (порог настраивается, 1–4), чипы делаются по ширине текста и стоят
  слева, а часть, которая допишется к слову, подчёркнута (у исправлений и предсказаний подчёркивать нечего). Нажатие на
